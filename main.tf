locals {
  ...
  public_subnet_tag   = "public-subnet-${local.environment}"
  private_subnet_tag  = "private-subnet-${local.environment}"
  database_subnet_tag = "database-subnet-${local.environment}"
}
